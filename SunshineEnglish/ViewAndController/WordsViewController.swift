...
//  SunshineEnglish
//
//  Created by Winston on 2018/6/4.
...
extension WordsViewController
{
    ...
    func sortWords() {
        ...
        for index in 0...words.count-1 {
            ...
            if let wordString = dictionary["en"] as? String {
                ...
                let firstWord = String(upperWord.prefix(upTo: indexString))
    ...
    @objc func clickedBtn(btn: UIButton) {
        ...
        guard let word = dictionary["en"] as? String else {return}
        ...
        guard let URLs = URL.init(string: urlEncoding ?? "") else {return}
